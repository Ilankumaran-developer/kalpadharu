...
const Products = Loadable({
  loader: () => import('./views/Products/Products/Products'),
  loading: Loading,
})

const  Addproduct = Loadable({
  loader: () => import('./views/Products/Addproduct/Addproduct'),
  loading: Loading,
})


const EditProduct = Loadable({
  loader: () => import('./views/Products/Addproduct/EditProduct'),
  loading: Loading,
})
...
const routes = [
  ...
  { path: '/list/products', name: 'Products', component: Products },
  { path: '/add/product', name: 'Products', component: Addproduct },
